      ...
      >
        <GlassCard className="p-8 sm:p-10 border-blue-500/30" hoverEffect={false}>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              <label htmlFor="login-password" className="block text-base font-semibold text-slate-200 mb-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  autoFocus
                  className="w-full rounded-xl border border-[rgba(115,149,174,0.3)] bg-[rgba(6,19,33,0.85)] pl-11 pr-12 py-3 text-base text-white placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                />
                <button
                  type="button"
            ...
            {errorMsg && (
              <motion.div
                ...
                className="flex items-center gap-2 rounded-xl border border-rose-500/30 bg-rose-950/40 p-3.5 text-sm font-medium text-rose-300"
              >
                <AlertCircle className="h-4.5 w-4.5 flex-shrink-0 text-rose-400" />
                <span>{errorMsg}</span>
              </motion.div>
            )}
