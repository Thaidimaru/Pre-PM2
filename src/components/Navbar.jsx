      ...
      <div className="mx-auto flex h-full items-center justify-between px-6 lg:px-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xl font-black tracking-wide text-white lg:text-2xl drop-shadow-sm">
              NBTC MICROWAVE
            </span>
          </div>
        </div>
        ...
        {/* Live System Strip */}
        <div className="hidden md:flex items-center gap-4 text-base text-slate-300">
          {/* Online & Storage status indicator */}
          <div className="flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-950/40 px-3.5 py-1 text-emerald-300">
            <span className="relative flex h-2.5 w-2.5">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400 opacity-75" />
              <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-emerald-500" />
            </span>
            <span className="text-sm font-semibold">ระบบพร้อมใช้งาน</span>
          </div>

          <div className="hidden lg:flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-950/40 px-3.5 py-1 text-cyan-300 text-sm font-medium">
